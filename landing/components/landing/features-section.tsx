...
const features = [
  ...
  },
  {
    ...
    stats: { value: "🎵", label: "self-expression" },
  },
  {
    number: "03",
  ...
  },
  {
    ...
    stats: { value: "📈", label: "level up fast" },
  },
];
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid lg:grid-cols-12 gap-8 items-end">
            ...
            <div className="lg:col-span-5 lg:pb-4">
              <p className={`text-xl text-muted-foreground leading-relaxed transition-all duration-1000 delay-200 ${
                ...
                Everything you need to express yourself, connect authentically, and build your digital presence on your terms.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-4 lg:gap-6">
          {/* Large feature card */}
          <div 
            className={`lg:col-span-12 relative bg-card border border-border min-h-[500px] overflow-hidden group transition-all duration-700 flex rounded-lg ${
          ...
          >
            ...
            <div className="hidden lg:block relative w-[42%] shrink-0 overflow-hidden bg-gradient-to-r from-primary/20 to-accent/20">
