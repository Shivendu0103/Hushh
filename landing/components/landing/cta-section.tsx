  ...
  return (
    <section ref={sectionRef} className="relative py-24 lg:py-32 overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        <div
          className={`relative border border-accent/30 bg-gradient-to-br from-card via-card/80 to-card rounded-lg transition-all duration-1000 ${
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
              ...
              <div className="flex-1">
                ...
                <p className="text-xl text-muted-foreground mb-8 leading-relaxed max-w-xl">
                  Join our community of creators, artists, and dreamers. Experience authentic connection powered by real vibes and infinite possibilities.
                </p>
              ...
              <div className="flex-1 relative">
                <form onSubmit={handleSubmit} className="bg-background/50 backdrop-blur-sm border border-accent/20 rounded-lg p-8 space-y-6">
                  <div>
                    <h3 className="text-2xl font-display text-foreground mb-2">
                      {isLogin ? "Welcome Back" : "Start Your Journey"}
                    </h3>
                    <p className="text-sm text-muted-foreground">
                      {isLogin ? "Sign in to your Hushh account" : "Create your Hushh account and join the vibe"}
                    </p>
                  </div>
