      ...
      >
        <div className="max-w-2xl">
          ...
          <motion.h1
            ...
            className="text-6xl md:text-7xl lg:text-8xl font-bold leading-tight text-white mb-16 tracking-tight"
          >
          ...
          {/* Stats */}
          <motion.div variants={itemVariants} className="flex flex-wrap gap-12 md:gap-16">
            {[
