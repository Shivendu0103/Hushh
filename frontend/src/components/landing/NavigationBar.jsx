...
export function NavigationBar({ onOpenAuth }) {
          ...
          <div className="px-6 py-4 space-y-4">
            ...
            <div className="flex gap-4 pt-4 border-t border-border">
              <button 
                ...
                className="flex-1 px-4 py-2 border border-border rounded-full text-sm"
              >
                Login
              </button>
              <button 
                onClick={() => { setIsOpen(false); onOpenAuth('register'); }}
                className="flex-1 px-4 py-2 bg-primary text-white rounded-full text-sm font-medium"
              >
                Join
              </button>
            </div>
